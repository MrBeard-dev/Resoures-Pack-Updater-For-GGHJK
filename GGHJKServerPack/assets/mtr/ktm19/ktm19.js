...
var rawModels = ModelManager.loadPartedRawModel(Resources.manager(), Resources.idRelative("mtr:ktm19/ktm_19.obj"), null);
...
function render(ctx, state, train) {
	...
	for (i = 0; i < train.trainCars(); i++) {
		...
		*/
		...
		renderDoorWithChild(matrices, ctx,  models["k1"],  models["d1"], null, models["d1_1"], -firstAngle, -secondAngle, -1.161, 4.961, -1.220, 5.276, i);

		renderDoorWithChild(matrices, ctx,  models["k2"],  models["d2"], null, models["d2_2"], firstAngle, secondAngle, -1.161, 2.114, -1.220, 1.847, i);
		renderDoorWithChild(matrices, ctx, models["k3"], models["d3"], null, models["d3_3"], -firstAngle, -secondAngle, -1.161, 0.7203, -1.220, 0.9949, i);

		renderDoorWithChild(matrices, ctx, models["k4"], models["d4"], null, models["d4_4"], firstAngle, secondAngle, -1.161, -0.7139, -1.220, -0.9811, i);
		renderDoorWithChild(matrices, ctx, models["k5"], models["d5"], null, models["d5_5"], -firstAngle, -secondAngle, -1.161, -2.107, -1.220, -1.840, i);

		renderDoorWithChild(matrices, ctx, models["k6"], models["d6"], null, models["d6_6"], -firstAngle, -secondAngle, -1.140, -5.859, -1.220, -5.554, i);
	}
...
function uploadPartedModels(rawModels) {
	...
	for (it = rawModels.entrySet().iterator(); it.hasNext();) {
		...
		if (jsStringKey == "disp") entry.getValue().setAllRenderType("light");
