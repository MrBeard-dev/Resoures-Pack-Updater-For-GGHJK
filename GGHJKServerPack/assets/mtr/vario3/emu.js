    ...
    slots: [
        {
            ...
            pos: [
                [
                    [-0.245359, 1.96779, 7.12353],
                    [-0.245359, 1.69065, 7.10656],
                    [0.55245, 1.69065, 7.10656],
                    [0.55245, 1.96779, 7.12353],	// Правый Верхний Угол XYZ
                ],
            ],
            offsets: [[0, 0, 0]],
        },
        {
          ...
          pos: [
              [
                [-1.21792, 1.74549, 1.21417],	
                [-1.20011, 1.45801, 1.21417],
                [-1.20011, 1.45801, 2.05718],
                [-1.21792, 1.74549, 2.05718],
    ...
    slots: [
        {
            ...
            pos: [
                [
                    [-0.55155, 1.96779, 7.12353],
                    [-0.55155, 1.69065, 7.10656],
                    [-0.245359, 1.69065, 7.10656],
                    [-0.245359, 1.96779, 7.12353],	    // Правый Верхний Угол XYZ
                ],
            ],
            offsets: [[0, 0, 0]],
        },
        {
            ...
            pos: [
                [
                    [-1.21792, 1.74549, 0.897989],		// Левый Верхний Угол XYZ
                    [-1.20011, 1.45801, 0.897989],		// Левый Нижний Угол XYZ
                    [-1.20011, 1.45801, 1.21417],  // Правый Нижний Угол XYZ
                    [-1.21792, 1.74549, 1.21417],  // Правый Верхний Угол XYZ
                ],
            ],
            offsets: [[0, 0, 0]],
        },
...
let slotTailDestCfg = {							    // ЭМУ ОСНОВНОЙ ХВОСТОВОЙ (КРАСНЫЕ ОГНИ) ВАГОН
    ...
    slots: [
        ...
        },
        {
          ...
          pos: [
              [
                [-1.21813, 1.76555, -1.78615],
                [-1.20033, 1.47806, -1.78615],
                [-1.20033, 1.47806, -0.935928],
                [-1.21814, 1.76555, -0.935929],	// Правый Верхний Угол XYZ
              ],
          ],
          offsets: [[0, 0, 0]],
      },
    ...
    slots: [
        {
            ...
            pos: [
                [
                  [0.14649, 1.09091, -7.3954],		// Левый Верхний Угол XYZ
                  [0.14649, 0.899188 , -7.39536],		// Левый Нижний Угол XYZ
                  [-0.14494, 0.899188, -7.39536],
                  [-0.14494, 1.09091, -7.3954],
                ],
            ],
            offsets: [[0, 0, 0]],
        },
        {
          ...
          pos: [
              [
                  [-1.21814, 1.76554, -2.09512],
                  [-1.20033, 1.47806, -2.09512],
                  [-1.20033, 1.47806, -1.78615],
                  [-1.21813, 1.76555, -1.78615],
              ],
          ],
...
function render(ctx, state, train) {  
    if (state.pisRateLimit.shouldUpdate()) {
        ...
        [
            ...
            let fontSize = 65;  // Начальный размер шрифта для маршрута
            let fontMetrics;
            let textWidth;
            let textHeight;
            ...
            if (textWidth > 256) {
                ...
                g.drawString(EMURouteText, (265 - textWidth) / 2, 113);  // Фиксированное положение
            }
