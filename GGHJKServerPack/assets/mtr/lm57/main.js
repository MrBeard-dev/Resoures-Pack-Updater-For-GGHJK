...
var rawModels = ModelManager.loadPartedRawModel(Resources.manager(), Resources.idRelative("mtr:lm57/lm57_old.obj"), null);
...
function render(ctx, state, train) {
	...
	for (i = 0; i < train.trainCars(); i++) {
		...
		*/
		...
		let secondAngle = train.doorRightOpen[i] ? 170.0 * Math.PI / 180 * smoothCubic(train.doorValue()) : 0;
		...
		ctx.drawCarModel(models["bufer"], i, matrices);
		ctx.drawCarModel(models["pant"], i, matrices);

		//рендер дверей определен нижк=е
		renderDoorWithChild(matrices, ctx,  models["d1"],  models["d2"], models["d1_1"], models["d2_2"], firstAngle, secondAngle, -1.014, 6.640, -1.067, 6.305, i);
		renderDoorWithChild(matrices, ctx,  models["d3"],  null, models["d3_3"], null, -firstAngle, -secondAngle, -1.161, 5.609, -1.122, 5.947, i);

		renderDoorWithChild(matrices, ctx, models["d4"], models["d5"], models["d4_4"], models["d5_5"], firstAngle, secondAngle, -1.201, 0.7273, -1.201, 0.3829, i);
		renderDoorWithChild(matrices, ctx, models["d7"], models["d6"], models["d7_7"], models["d6_6"], -firstAngle, -secondAngle, -1.204, -0.7168, -1.204, -0.3660, i)

		renderDoorWithChild(matrices, ctx, models["d8"], models["d9"], models["d8_8"], models["d9_9"], firstAngle, secondAngle, -1.191, -5.498, -1.165, -5.833, i);
		renderDoorWithChild(matrices, ctx, models["d10"], null, models["d10_10"], null, -firstAngle, -secondAngle, -1.111, -6.535, -1.137, -6.199, i)
