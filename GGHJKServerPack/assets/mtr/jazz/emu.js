    ...
    slots: [
        {
            ...
            pos: [
                [
                    [-0.43292, 2.15093, 4.23309],
                    [-0.43292, 1.85129, 4.23309], 
                    [0.746946, 1.85129, 4.23309],
                    [0.746946, 2.15093, 4.23309],	// Правый Верхний Угол XYZ
                ],
            ],
            offsets: [[0, 0, 0]],
        },
        {
          ...
          pos: [
              [
                  [-1.22444, 1.65638, -1.28354],
                  [-1.23151, 1.4, -1.28354],
                  [-1.23151, 1.4, -0.248684],
                  [-1.22444, 1.65638, -0.248684],	// Правый Верхний Угол XYZ
              ],    
          ],
          offsets: [[0, 0, 0.01]],
      },
    ...
    slots: [
        {
            ...
            pos: [
                [
                    [-0.746946, 2.15093, 4.23309],
                    [-0.746946, 1.85129, 4.23309],		// Левый Нижний Угол XYZ
                    [-0.43292, 1.85129, 4.23309],    // Правый Нижний Угол XYZ
                    [-0.43292, 2.15093, 4.23309],	    // Правый Верхний Угол XYZ
                ],
            ],
            offsets: [[0, 0, 0]],
        },
        {
            ...
            pos: [  
                [
                    [-1.22444, 1.65638, -1.58439],
                    [-1.23151, 1.4, -1.58439],		// Левый Нижний Угол XYZ
                    [-1.23151, 1.4, -1.28354],  // Правый Нижний Угол XYZ
                    [-1.22444, 1.65638, -1.28354],  // Правый Верхний Угол XYZ
                ],
            ],
            offsets: [[0, 0, 0.01]],
        },
        ...
        },
        {
            ...
            pos: [  
                [
                    [-1.24395, 0.866433, 0.047164],
                    [-1.25392, 0.454222, 0.047164],		// Левый Нижний Угол XYZ
                    [-1.25392, 0.454222, 0.459496],  // Правый Нижний Угол XYZ
                    [-1.24395, 0.866433, 0.459496],  // Правый Верхний Угол XYZ
                ],
            ],
            offsets: [[0, 0, 0]],
        },
