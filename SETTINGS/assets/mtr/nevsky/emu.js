    ...
    slots: [
        {
          ...
          pos: [
              [
                [-1.21945, 1.48162, 4.40145],
                [-1.21945, 1.22192, 4.40145],
                [-1.21945, 1.22192, 5.54351],
                [-1.21945, 1.48162, 5.54351],
              ],
          ],
          offsets: [[0, 0, 0]],
      },
      {
          name: 'head-left-side-dest',
          texArea: [0, 0, 1024, 128],
          pos: [
              [
                [1.21521, 1.48162, 5.19835],
                [1.21521, 1.22192, 5.19835],
                [1.21521, 1.22192, 4.01577],
                [1.21521, 1.48162, 4.01577],
              ],
          ],
          offsets: [[0, 0, 0]],
      },
    ...
    slots: [
        {
            ...
            pos: [
                [
                    [-0.559827, 1.68874, 7.72017],
                    [-0.559827, 1.42724, 7.72017],
                    [0.554538, 1.42724, 7.72017],
                    [0.554538, 1.68874, 7.72017],
                ],
            ],
            offsets: [[0, 0, 0]],
        }
    ...
    slots: [
        {
            ...
            pos: [
                [
                    [-0.25447, 2.04017, 7.60067],
                    [-0.25447, 1.73299, 7.60067],
                    [0.25447, 1.73299, 7.60067],
                    [0.25447, 2.04017, 7.60067],
                ],
            ],
...
let slotHeadSideRouteCfg = {							// ЭМУ МАРШРУТ ГОЛОВНОЙ (БЕЛЫЕ ОГНИ) ВАГОН
    version: 1,
    texSize: [256, 128],
    slots: [
        {
            ...
            pos: [
                [
                    [-1.21945, 1.48162, 4.01577],  
                    [-1.21945, 1.22192, 4.01577],
                    [-1.21945, 1.22192, 4.40145],
                    [-1.21945, 1.48162, 4.40145],
                ],
            ],
        ...
        {
            name: 'head-left-side-route',
            texArea: [0, 0, 256, 128],
            pos: [
                [
                    [1.21521, 1.48162, 5.54351],  
                    [1.21521, 1.22192, 5.54351],
                    [1.21521, 1.22192, 5.19835],
                    [1.21521, 1.48162, 5.19835],
                ],
            ],
    ...
    slots: [
        {
          ...
          pos: [
              [
                [-1.23467, 1.48162, 0.472332],
                [-1.23467, 1.22192, 0.472332],
                [-1.23467, 1.22192, 1.7175],
                [-1.23467, 1.48162, 1.7175],
              ],
          ],
          offsets: [[0, 0, 0]],
      },
      {
          name: 'mid-left-side-dest',
          texArea: [0, 0, 1024, 128],
          pos: [
              [
                [1.22856, 1.48162, -0.463449],
                [1.22856, 1.22192, -0.463449],
                [1.22856, 1.22192, -1.70902],
                [1.22856, 1.48162, -1.70902],
              ],
          ],
          offsets: [[0, 0, 0]],
      },
    ...
    slots: [
        {
          ...
          pos: [
              [
                    [-1.23467, 1.48162, 0.110589],
                    [-1.23467, 1.22192, 0.110589],
                    [-1.23467, 1.22192, 0.472332],
                    [-1.23467, 1.48162, 0.472332],
              ],
          ],
      ...
      {
          name: 'mid-left-side-route',
          texArea: [0, 0, 256, 128],
          pos: [
              [
                    [1.22856, 1.48162, -0.102109],
                    [1.22856, 1.22192, -0.102109],
                    [1.22856, 1.22192, -0.463449],
                    [1.22856, 1.48162, -0.463449],
              ],
          ],
    ...
    slots: [
        {
          ...
          pos: [
              [
                [-1.22041, 1.48159, -5.1753],
                [-1.22041, 1.22188, -5.1753],
                [-1.22041, 1.22188, -4.02121],
                [-1.22041, 1.48159, -4.02121],
              ],
          ],
          offsets: [[0, 0, 0]],
      },
      {
          name: 'tail-left-side-dest',
          texArea: [0, 0, 1024, 128],
          pos: [
              [
                [1.21481, 1.48159, -4.40493],
                [1.21481, 1.22188, -4.40493],
                [1.21481, 1.22188, -5.54895],
                [1.21481, 1.48159, -5.54895],
              ],
          ],
          offsets: [[0, 0, 0]],
      },
    ...
    slots: [
        {
            ...
            pos: [
                [
                    [0.555047, 1.68869, -7.72561],
                    [0.555047, 1.4272, -7.72561],
                    [-0.559318, 1.4272, -7.72561],
                    [-0.559318, 1.68869, -7.72561],
                ],
            ],
            offsets: [[0, 0, 0]],
        }
    ...
    slots: [
        {
            ...
            pos: [
                [
                    [0.24969, 2.04013, -7.60535],
                    [0.24969, 1.73299, -7.60535],
                    [-0.25925, 1.73299, -7.60535],
                    [-0.25925, 2.04013, -7.60535],
                ],
            ],
            offsets: [[0, 0, 0]],
        },
...
let slotTailSideRouteCfg = {						    // ЭМУ МАРШРУТ ХВОСТОВОЙ (КРАСНЫЕ ОГНИ) ВАГОН
    version: 1,
    texSize: [256, 128],
    slots: [
        {
          ...
          pos: [
              [
                    [-1.22041, 1.48159, -5.54895],
                    [-1.22041, 1.22188, -5.54895],
                    [-1.22041, 1.22188, -5.1753],
                    [-1.22041, 1.48159, -5.1753],
              ],
          ],
      ...
      {
          name: 'tail-left-side-route',
          texArea: [0, 0, 256, 128],
          pos: [
              [
                    [1.21481, 1.48159, -4.02121],
                    [1.21481, 1.22188, -4.02121],
                    [1.21481, 1.22188, -4.40492],
                    [1.21481, 1.48159, -4.40492],
              ],    
          ],
          offsets: [[0, 0, 0]],
      },
...
let dhHeadBaseSideRoute = new DisplayHelper(slotHeadSideRouteCfg);
...
let dhTailBaseSideRoute = new DisplayHelper(slotTailSideRouteCfg);
...
function create(ctx, state, train) {
    ...
    state.dhHeadSideRoute = dhHeadBaseSideRoute.create();
    ...
    state.dhTailSideRoute = dhTailBaseSideRoute.create();
...
function dispose(ctx, state, train) {
    ...
    if (state.dhHeadSideRoute) state.dhHeadSideRoute.close();
    ...
    if (state.dhTailSideRoute) state.dhTailSideRoute.close();
...
function render(ctx, state, train) {  
    if (state.pisRateLimit.shouldUpdate()) {
        ...
        // В функции render изменяем блок отрисовки боковых дисплеев
        [
            { dh: state.dhHeadDest, graphicsName: 'head-side-dest' },
            { dh: state.dhHeadDest, graphicsName: 'head-left-side-dest' },
            { dh: state.dhMidDest, graphicsName: 'mid-side-dest' },
            { dh: state.dhMidDest, graphicsName: 'mid-left-side-dest' },
            { dh: state.dhTailDest, graphicsName: 'tail-side-dest' },
            { dh: state.dhTailDest, graphicsName: 'tail-left-side-dest' },
        ].forEach((element) => {
             let dh = element.dh;
        ...
        [ 
            ...
            if (textWidth > 256) {
                ...
                g.drawString(EMURouteText, (256 - textWidth) / 2, 110);
            }
        ...
        [ 
            { dh: state.dhHeadSideRoute, graphicsName: 'head-side-route', text: EMURouteText },
            { dh: state.dhHeadSideRoute, graphicsName: 'head-left-side-route', text: EMURouteText },
            { dh: state.dhMidRoute, graphicsName: 'mid-side-route', text: EMURouteText },
            { dh: state.dhMidRoute, graphicsName: 'mid-left-side-route', text: EMURouteText },
            { dh: state.dhTailSideRoute, graphicsName: 'tail-side-route', text: EMURouteText },
            { dh: state.dhTailSideRoute, graphicsName: 'tail-left-side-route', text: EMURouteText },
        ].forEach((element) => {
            let dh = element.dh;
            g = dh.graphicsFor(element.graphicsName);
            g.setColor(Color.WHITE);
        ...
        // Проверка и активация софитов (исправленная версия)
        if (train.siding() !== null) {
            let sidingParts = train.siding().name.split('\\|');
            if (sidingParts.length > 2 && sidingParts[2] === '1') {
    ...
    ctx.drawCarModel(state.dhHeadSideRoute.model, 0, null);
    ...
    ctx.drawCarModel(state.dhTailSideRoute.model, train.trainCars() - 1, null);
    
    // Отрисовка софитов (исправленная версия)
    if (train.siding() !== null) {
        let sidingParts = train.siding().name.split('\\|');
        if (sidingParts.length > 2 && sidingParts[2] === '1') {
