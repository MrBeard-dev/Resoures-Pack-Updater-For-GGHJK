    ...
    slots: [
        {
            ...
            pos: [
                [
                    [-0.304309, 1.91589, 7.19912],
                    [-0.304309, 1.69355, 7.18062],
                    [0.56311, 1.69355, 7.18062],
                    [0.56311, 1.91589, 7.19912],	// Правый Верхний Угол XYZ
                ],
            ],
            offsets: [[0, 0, 0]],
        },
        {
          ...
          pos: [
              [
                [-1.23744, 1.67743, 2.56552], 	
                [-1.21687, 1.42215, 2.56552], 
                [-1.21687, 1.42215, 3.61357],
                [-1.23744, 1.67743, 3.61357],
    ...
    slots: [
        {
            ...
            pos: [
                [
                    [-0.557738, 1.91589, 7.19912],
                    [-0.557738, 1.69355, 7.18062],
                    [-0.304309, 1.69355, 7.18062],
                    [-0.304309, 1.91589, 7.19912],	    // Правый Верхний Угол XYZ
                ],
            ],
            offsets: [[0, 0, 0]],
        },
        {
            ...
            pos: [
                [
                    [-1.23743, 1.67744, 2.24282],		// Левый Верхний Угол XYZ
                    [-1.21687, 1.42215, 2.24282],		// Левый Нижний Угол XYZ
                    [-1.21687, 1.42215, 2.56552],  // Правый Нижний Угол XYZ
                    [-1.23744, 1.67743, 2.56552],  // Правый Верхний Угол XYZ
                ],
            ],
            offsets: [[0, 0, 0]],
        },
    ...
    slots: [
        {
            ...
            pos: [
                [
                  [0.163725, 1.10048, -7.42131],		// Левый Верхний Угол XYZ
                  [0.163725, 0.869738, -7.42109],		// Левый Нижний Угол XYZ
                  [-0.163725, 0.869738, -7.42109],
                  [-0.163725, 1.10048, -7.42131],
                ],
            ],
            offsets: [[0, 0, 0]],
        },
...
function renderScrollingText(dh, graphicsName, text, scrollPos, maxScrollWidth, texWidth, texHeight) {
    ...
    if (textWidth > texWidth) {
        ...
        g.drawString(text, xPosition, 114);
    }
