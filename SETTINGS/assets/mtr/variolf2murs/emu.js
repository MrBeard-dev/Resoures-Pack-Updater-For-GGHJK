    ...
    slots: [
        {
            ...
            pos: [
                [
                    [-0.313549, 1.90789, 5.02335],
                    [-0.313549, 1.71221, 5.00645],
                    [0.551897, 1.71221, 5.00645],
                    [0.551897, 1.90789, 5.02335],	// Правый Верхний Угол XYZ
                ],
            ],
            offsets: [[0, 0, 0]],
        },
        {
          ...
          pos: [
              [
                [-1.21511, 1.68631, -0.910655],	
                [-1.19736, 1.48085, -0.910655],
                [-1.19736, 1.48085, -0.025406],
                [-1.21511, 1.68631, -0.025406],
    ...
    slots: [
        {
            ...
            pos: [
                [
                    [-0.548528, 1.90789, 5.02335],
                    [-0.548528, 1.71221, 5.00645],
                    [-0.313549, 1.71221, 5.00645],
                    [-0.313549, 1.90789, 5.02335],	   // Правый Верхний Угол XYZ
                ],
            ],
            offsets: [[0, 0, 0]],
        },
        {
            ...
            pos: [
                [
                    ...
                    [-1.21511, 1.68631, -1.18051],		// Левый Верхний Угол XYZ
                    [-1.19736, 1.48085, -1.18051],		// Левый Верхний Угол XYZ
                    [-1.19736, 1.48085, -0.910655],		// Левый Верхний Угол XYZ
                    [-1.21511, 1.68631, -0.910655 ],		// Левый Нижний Угол XYZ
                ],
            ],
            offsets: [[0, 0, 0]],
        },
...
let slotTailDestCfg = {							    // ЭМУ ОСНОВНОЙ ХВОСТОВОЙ (КРАСНЫЕ ОГНИ) ВАГОН
    ...
    slots: [
        ...
        },
        {
          ...
          pos: [
              [
                [-1.2077, 1.6413, 0.226593],
                [-1.18995, 1.43585, 0.226595],
                [-1.18995, 1.43585, 1.12049],
                [-1.2077, 1.6413, 1.12049],	// Правый Верхний Угол XYZ
              ],
          ],
          offsets: [[0, 0, 0]],
      },
    ...
    slots: [
        {
            ...
            pos: [
                [
                  [0.15217, 0.968863, -5.28974],		// Левый Верхний Угол XYZ
                  [0.15217, 0.777759, -5.2897],		// Левый Нижний Угол XYZ
                  [-0.138319, 0.777759, -5.2897],
                  [-0.138319, 0.968863, -5.28974],
                ],
            ],
            offsets: [[0, 0, 0]],
        },
        {
          ...
          pos: [
              [
                  [-1.2077, 1.6413, -0.03496],
                  [-1.18995, 1.43585, -0.034959],
                  [-1.18995, 1.43585, 0.226595],
                  [-1.2077, 1.6413, 0.226593],
              ],
          ],
...
function render(ctx, state, train) {  
    if (state.pisRateLimit.shouldUpdate()) {
        ...
        [
            ...
            let fontSize = 80;  // Начальный размер шрифта для маршрута
            let fontMetrics;
            let textWidth;
            let textHeight;
            ...
            if (textWidth > 256) {
                ...
                g.drawString(EMURouteText, (265 - textWidth) / 2, 115);  // Фиксированное положение
            }
