...
const leftPos = getCubeVertices([0.548,2.078,0.750],[0.798,2.078,-0.750], [0.673,2.078,0],0,-180,150);
const rightPos = getCubeVertices([-0.548,2.078,-0.750],[-0.798,2.078,0.750], [-0.673,2.078,0],0,180,-150);
    ...
    "slots": [
        {
            ...
            "offsets": [[0, 0, -5], [0, 0, -2],[0, 0, 2.5], [0, 0, 7.5]]
        },
        {
            "name": "lcd_door_right",
